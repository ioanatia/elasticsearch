...
public class LuceneQueryExpressionEvaluator implements EvalOperator.ExpressionEvaluator {
    ...
    public LuceneQueryExpressionEvaluator(BlockFactory blockFactory, List<EsPhysicalOperationProviders.ShardContext> shardContexts, EvalOperator.ExpressionEvaluator queryExpressionEvaluator) {
    ...
    public static class Factory implements EvalOperator.ExpressionEvaluator.Factory {
        ...
        public Factory(List<EsPhysicalOperationProviders.ShardContext> shardContexts, EvalOperator.ExpressionEvaluator.Factory queryStringEvaluator) {
            this.shardContexts = shardContexts;
        ...
        public EvalOperator.ExpressionEvaluator get(DriverContext context) {
            return new LuceneQueryExpressionEvaluator(context.blockFactory(), shardContexts, queryStringEvaluator.get(context));
        }
    }
}
