 ...
 */
public final class ToTextFromCartesianPointEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromCartesianPointEvaluator.class);

  private final ExpressionEvaluator wkb;

  public ToTextFromCartesianPointEvaluator(Source source, ExpressionEvaluator wkb,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromCartesianPoint(value);
  }
  ...
  public String toString() {
    return "ToTextFromCartesianPointEvaluator[" + "wkb=" + wkb + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromCartesianPointEvaluator get(DriverContext context) {
      return new ToTextFromCartesianPointEvaluator(source, wkb.get(context), context);
    }
