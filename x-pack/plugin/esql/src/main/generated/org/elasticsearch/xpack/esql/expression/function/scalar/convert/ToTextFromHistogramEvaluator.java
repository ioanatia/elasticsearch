 ...
 */
public final class ToTextFromHistogramEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromHistogramEvaluator.class);

  private final ExpressionEvaluator histogram;

  public ToTextFromHistogramEvaluator(Source source, ExpressionEvaluator histogram,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromHistogram(value);
  }
  ...
  public String toString() {
    return "ToTextFromHistogramEvaluator[" + "histogram=" + histogram + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromHistogramEvaluator get(DriverContext context) {
      return new ToTextFromHistogramEvaluator(source, histogram.get(context), context);
    }
