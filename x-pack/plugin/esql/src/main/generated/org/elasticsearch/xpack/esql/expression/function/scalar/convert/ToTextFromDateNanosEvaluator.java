 ...
 */
public final class ToTextFromDateNanosEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromDateNanosEvaluator.class);

  private final ExpressionEvaluator datetime;

  private final DateFormatter formatter;

  public ToTextFromDateNanosEvaluator(Source source, ExpressionEvaluator datetime,
  ...
  private BytesRef evalValue(LongVector container, int index) {
    ...
    return ToText.fromDateNanos(value, this.formatter);
  }
  ...
  public String toString() {
    return "ToTextFromDateNanosEvaluator[" + "datetime=" + datetime + ", formatter=" + formatter + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromDateNanosEvaluator get(DriverContext context) {
      return new ToTextFromDateNanosEvaluator(source, datetime.get(context), formatter, context);
    }
