 ...
 */
public final class ToTextFromGeoGridEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromGeoGridEvaluator.class);

  private final ExpressionEvaluator gridId;

  private final DataType dataType;

  public ToTextFromGeoGridEvaluator(Source source, ExpressionEvaluator gridId, DataType dataType,
  ...
  private BytesRef evalValue(LongVector container, int index) {
    ...
    return ToText.fromGeoGrid(value, this.dataType);
  }
  ...
  public String toString() {
    return "ToTextFromGeoGridEvaluator[" + "gridId=" + gridId + ", dataType=" + dataType + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromGeoGridEvaluator get(DriverContext context) {
      return new ToTextFromGeoGridEvaluator(source, gridId.get(context), dataType, context);
    }
