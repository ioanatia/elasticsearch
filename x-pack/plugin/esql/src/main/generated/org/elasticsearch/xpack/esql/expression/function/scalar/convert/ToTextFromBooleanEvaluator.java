 ...
 */
public final class ToTextFromBooleanEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromBooleanEvaluator.class);

  private final ExpressionEvaluator bool;

  public ToTextFromBooleanEvaluator(Source source, ExpressionEvaluator bool,
  ...
  private BytesRef evalValue(BooleanVector container, int index) {
    ...
    return ToText.fromBoolean(value);
  }
  ...
  public String toString() {
    return "ToTextFromBooleanEvaluator[" + "bool=" + bool + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromBooleanEvaluator get(DriverContext context) {
      return new ToTextFromBooleanEvaluator(source, bool.get(context), context);
    }
