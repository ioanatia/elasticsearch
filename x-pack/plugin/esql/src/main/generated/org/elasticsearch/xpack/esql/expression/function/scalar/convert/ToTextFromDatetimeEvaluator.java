 ...
 */
public final class ToTextFromDatetimeEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromDatetimeEvaluator.class);

  private final ExpressionEvaluator datetime;

  private final DateFormatter formatter;

  public ToTextFromDatetimeEvaluator(Source source, ExpressionEvaluator datetime,
  ...
  private BytesRef evalValue(LongVector container, int index) {
    ...
    return ToText.fromDatetime(value, this.formatter);
  }
  ...
  public String toString() {
    return "ToTextFromDatetimeEvaluator[" + "datetime=" + datetime + ", formatter=" + formatter + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromDatetimeEvaluator get(DriverContext context) {
      return new ToTextFromDatetimeEvaluator(source, datetime.get(context), formatter, context);
    }
