 ...
 */
public final class ToTextFromFloatEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromFloatEvaluator.class);

  private final ExpressionEvaluator flt;

  public ToTextFromFloatEvaluator(Source source, ExpressionEvaluator flt,
  ...
  public String toString() {
    return "ToTextFromFloatEvaluator[" + "flt=" + flt + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromFloatEvaluator get(DriverContext context) {
      return new ToTextFromFloatEvaluator(source, flt.get(context), context);
    }
