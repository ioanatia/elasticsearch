 ...
 */
public final class ToTextFromVersionEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromVersionEvaluator.class);

  private final ExpressionEvaluator version;

  public ToTextFromVersionEvaluator(Source source, ExpressionEvaluator version,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromVersion(value);
  }
  ...
  public String toString() {
    return "ToTextFromVersionEvaluator[" + "version=" + version + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromVersionEvaluator get(DriverContext context) {
      return new ToTextFromVersionEvaluator(source, version.get(context), context);
    }
