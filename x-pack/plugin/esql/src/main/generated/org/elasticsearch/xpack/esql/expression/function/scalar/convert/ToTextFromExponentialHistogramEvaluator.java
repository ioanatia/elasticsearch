...
/**
 * {@link ExpressionEvaluator} implementation for {@link ToText}.
 * This class is generated. Edit {@code ConvertEvaluatorImplementer} instead.
 */
public final class ToTextFromExponentialHistogramEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromExponentialHistogramEvaluator.class);

  private final ExpressionEvaluator histogram;

  public ToTextFromExponentialHistogramEvaluator(Source source, ExpressionEvaluator histogram,
  ...
  private BytesRef evalValue(ExponentialHistogramBlock container, int index,
    ...
    return ToText.fromExponentialHistogram(value);
  }

  @Override
  public String toString() {
    return "ToTextFromExponentialHistogramEvaluator[" + "histogram=" + histogram + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromExponentialHistogramEvaluator get(DriverContext context) {
      return new ToTextFromExponentialHistogramEvaluator(source, histogram.get(context), context);
    }
