 ...
 */
public final class ToTextFromIPEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromIPEvaluator.class);

  private final ExpressionEvaluator ip;

  public ToTextFromIPEvaluator(Source source, ExpressionEvaluator ip, DriverContext driverContext) {
  ...
  public String toString() {
    return "ToTextFromIPEvaluator[" + "ip=" + ip + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromIPEvaluator get(DriverContext context) {
      return new ToTextFromIPEvaluator(source, ip.get(context), context);
    }
