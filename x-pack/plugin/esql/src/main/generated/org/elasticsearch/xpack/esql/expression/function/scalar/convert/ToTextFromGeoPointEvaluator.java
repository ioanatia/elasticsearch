 ...
 */
public final class ToTextFromGeoPointEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromGeoPointEvaluator.class);

  private final ExpressionEvaluator wkb;

  public ToTextFromGeoPointEvaluator(Source source, ExpressionEvaluator wkb,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromGeoPoint(value);
  }
  ...
  public String toString() {
    return "ToTextFromGeoPointEvaluator[" + "wkb=" + wkb + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromGeoPointEvaluator get(DriverContext context) {
      return new ToTextFromGeoPointEvaluator(source, wkb.get(context), context);
    }
