 ...
 */
public final class ToTextFromGeoShapeEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromGeoShapeEvaluator.class);

  private final ExpressionEvaluator wkb;

  public ToTextFromGeoShapeEvaluator(Source source, ExpressionEvaluator wkb,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromGeoShape(value);
  }
  ...
  public String toString() {
    return "ToTextFromGeoShapeEvaluator[" + "wkb=" + wkb + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromGeoShapeEvaluator get(DriverContext context) {
      return new ToTextFromGeoShapeEvaluator(source, wkb.get(context), context);
    }
