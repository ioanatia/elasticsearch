 ...
 */
public final class ToTextFromDoubleEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromDoubleEvaluator.class);

  private final ExpressionEvaluator dbl;

  public ToTextFromDoubleEvaluator(Source source, ExpressionEvaluator dbl,
  ...
  private BytesRef evalValue(DoubleVector container, int index) {
    ...
    return ToText.fromDouble(value);
  }
  ...
  public String toString() {
    return "ToTextFromDoubleEvaluator[" + "dbl=" + dbl + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromDoubleEvaluator get(DriverContext context) {
      return new ToTextFromDoubleEvaluator(source, dbl.get(context), context);
    }
