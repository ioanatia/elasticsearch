 ...
 */
public final class ToTextFromCartesianShapeEvaluator extends AbstractConvertFunction.AbstractEvaluator {
  private static final long BASE_RAM_BYTES_USED = RamUsageEstimator.shallowSizeOfInstance(ToTextFromCartesianShapeEvaluator.class);

  private final ExpressionEvaluator wkb;

  public ToTextFromCartesianShapeEvaluator(Source source, ExpressionEvaluator wkb,
  ...
  private BytesRef evalValue(BytesRefVector container, int index, BytesRef scratchPad) {
    ...
    return ToText.fromCartesianShape(value);
  }
  ...
  public String toString() {
    return "ToTextFromCartesianShapeEvaluator[" + "wkb=" + wkb + "]";
  }
  ...
  public static class Factory implements ExpressionEvaluator.Factory {
    ...
    @Override
    public ToTextFromCartesianShapeEvaluator get(DriverContext context) {
      return new ToTextFromCartesianShapeEvaluator(source, wkb.get(context), context);
    }
