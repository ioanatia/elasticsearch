            ...
            while (true) {
                if (plan instanceof TopN topN && topN.local() == false) {
                    ...
                    if (missingAttributes.isEmpty()) {
                        ...
                        return new TopN(topN.source(), transformedEnrich, topN.order(), topN.limit(), topN.offset(), false);
                    } else {
                        ...
                        var copyTop = new TopN(topN.source(), transformedEnrich, newOrder, topN.limit(), null, false);
