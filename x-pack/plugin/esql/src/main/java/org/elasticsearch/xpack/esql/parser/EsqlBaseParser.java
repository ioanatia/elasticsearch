...
public class EsqlBaseParser extends ParserConfig {
  ...
  public static final int
    ...
    RULE_subQuery = 65, RULE_subQueryCommand = 66, RULE_subQueryTailCommand = 67;
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "forkCommand", "subQuery", "subQueryCommand", "subQueryTailCommand"
    };
  }
  ...
  public final SubQueryCommandContext subQueryCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 132, RULE_subQueryCommand);
    int _la;
    try {
      enterOuterAlt(_localctx, 1);
      {
  ...
  public final SubQueryTailCommandContext subQueryTailCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 134, RULE_subQueryTailCommand);
    try {
      setState(652);
      _errHandler.sync(this);
      switch (_input.LA(1)) {
