...
public class EsqlBaseParser extends Parser {
  ...
  public static final int
    ...
    FROM_LINE_COMMENT=75, FROM_MULTILINE_COMMENT=76, FROM_WS=77, RETRIEVE_UNQUOTED_IDENTIFIER=78, 
    RETRIEVE_LINE_COMMENT=79, RETRIEVE_MULTILINE_COMMENT=80, RETRIEVE_WS=81, 
    ID_PATTERN=82, PROJECT_LINE_COMMENT=83, PROJECT_MULTILINE_COMMENT=84, 
  ...
  public static final int
    ...
    RULE_retrieveCommand = 17, RULE_retrieveIdentifier = 18, RULE_retrieveOptions = 19, 
    RULE_configOption = 20, RULE_metadata = 21, RULE_metadataOption = 22, 
    RULE_deprecated_metadata = 23, RULE_evalCommand = 24, RULE_statsCommand = 25, 
    ...
    RULE_limitCommand = 32, RULE_sortCommand = 33, RULE_orderExpression = 34, 
    RULE_keepCommand = 35, RULE_dropCommand = 36, RULE_renameCommand = 37, 
    RULE_renameClause = 38, RULE_dissectCommand = 39, RULE_grokCommand = 40, 
    RULE_mvExpandCommand = 41, RULE_commandOptions = 42, RULE_commandOption = 43, 
    RULE_booleanValue = 44, RULE_numericValue = 45, RULE_decimalValue = 46, 
    RULE_integerValue = 47, RULE_string = 48, RULE_comparisonOperator = 49, 
  ...
  private static String[] makeRuleNames() {
    return new String[] {
      ...
      "fromCommand", "fromIdentifier", "fromOptions", "retrieveCommand", "retrieveIdentifier", 
      "retrieveOptions", "configOption", "metadata", "metadataOption", "deprecated_metadata", 
  ...
  private static String[] makeLiteralNames() {
    return new String[] {
      ...
      "'rename'", "'retrieve'", "'row'", "'show'", "'sort'", "'stats'", "'where'", 
  ...
  private static String[] makeSymbolicNames() {
    return new String[] {
      ...
      "FROM_MULTILINE_COMMENT", "FROM_WS", "RETRIEVE_UNQUOTED_IDENTIFIER", 
      "RETRIEVE_LINE_COMMENT", "RETRIEVE_MULTILINE_COMMENT", "RETRIEVE_WS", 
  ...
  public final RetrieveCommandContext retrieveCommand() throws RecognitionException {
    ...
    enterRule(_localctx, 34, RULE_retrieveCommand);
    try {
      int _alt;
      enterOuterAlt(_localctx, 1);
      {
  ...
  public final RetrieveIdentifierContext retrieveIdentifier() throws RecognitionException {
    ...
    enterRule(_localctx, 36, RULE_retrieveIdentifier);
    int _la;
    try {
      enterOuterAlt(_localctx, 1);
      {
  ...
  public final RetrieveOptionsContext retrieveOptions() throws RecognitionException {
    ...
    enterRule(_localctx, 38, RULE_retrieveOptions);
    try {
      int _alt;
      enterOuterAlt(_localctx, 1);
      {
  ...
  public final ConfigOptionContext configOption() throws RecognitionException {
    ...
    enterRule(_localctx, 40, RULE_configOption);
    try {
      enterOuterAlt(_localctx, 1);
      {
      setState(327);
