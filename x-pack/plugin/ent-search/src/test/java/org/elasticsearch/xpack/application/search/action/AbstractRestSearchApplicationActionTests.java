...
public abstract class AbstractRestSearchApplicationActionTests extends ESTestCase {
    protected void checkLicenseForRequest(FakeRestRequest request) throws Exception {
        ...
        final SearchApplicationRestHandler action = getRestAction(licenseState);
    ...
    protected abstract SearchApplicationRestHandler getRestAction(XPackLicenseState licenseState);
}
